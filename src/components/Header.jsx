...
const Header = () => {
  ...
  return (
    <div className="">
      <nav id="header" className="w-full flex z-30 top-0 py-1 bg-gray-100">
        <div className="w-full container mx-auto flex flex-wrap items-center justify-between mt-0 px-6 py-3">
          <input className="hidden" type="checkbox" id="menu-toggle" />

          <div className="order-2 md:order-1 mt-2 max-md:mr-10">
            <Link
              className="flex items-text-white tracking-wide no-underline hover:no-underline font-bold text-xl max-sm:text-base"
              to="/"
            >
              <span className="text-left absolute top-0 left-0 ml-4 mt-4">
                GOLDEN WHISPER
              </span>
            </Link>
          </div>
      ...
      <nav id="header" className="w-full z-30 top-0 py-1 shadow bg-gray-100">
          ...
          >
            {navbar ? (
              ...
              >
                <path
                  fillRule="evenodd"
                  d="M4.293 4.293a1 1 0 011.414 0L10 8.586l4.293-4.293a1 1 0 111.414 1.414L11.414 10l4.293 4.293a1 1 0 01-1.414 1.414L10 11.414l-4.293 4.293a1 1 0 01-1.414-1.414L8
        ...
        <div className="w-full container mx-auto flex flex-wrap items-center justify-center mt-0 px-6 py-3">
          ...
          <div>
            ...
            >
              <ul className="md:flex items-center justify-center text-1xl pt-6 md:pt-0">
                <li>
                  <Link
